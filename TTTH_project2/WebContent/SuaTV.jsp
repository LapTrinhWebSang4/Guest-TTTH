	...
	<!--nav-->
        ...
        <div class="row">
             ...
             <div class="panel panel-primary">
              <div class="panel-heading"  style="color: #f6bb42 "><h3><Strong>Sửa Đổi</Strong></h3></div>
              <div class="form-group">
              <div class="col-md-13 well">

              <div class="form-group">
                  <label for="inputlg">Tên Tài Khoản </label>
                  <input class="form-control" id="inputlg" type="text" placeholder="qtv001" disabled>
              </div>
              
              <div class="form-group">
                  <label for="inputlg">Mật Khầu  </label>
                  <input class="form-control" id="inputmk" type="text" value="" ="123456789" >
              </div>

              <div class="form-group">
                  <label for="inputlg">Tên Thành Viên </label>
                  <input class="form-control" id="inputtv" type="text" value ="Nguyen Van T" >
              </div>
              ...
              <div class="form-group" style="text-align: right; padding-top: 10px;padding-bottom: 10px">
                <a href="quantri.html" class="btn btn-success" role="button"> Sửa </a>
