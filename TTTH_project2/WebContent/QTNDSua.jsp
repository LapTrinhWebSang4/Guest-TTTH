	...
	<!--end nav-->
		...
		<div class="main-container ace-save-state" id="main-container">
            ...
            <div class="panel panel-primary">
              <div class="panel-heading" style="color: #f6bb42 "><h3><Strong>Chỉnh sửa thông báo</Strong></h3></div>
              	
             		 <div class="col-md-13 well">

			              <div class="form-group">
			                  <label for="inputtd">Tên Tiêu Đề: </label>
			                  <input class="form-control" id="inputtd" type="text" placeholder="" value="Các thủ Thuật Máy Tính">
...
*Thủ Thuật 2 : bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb</textarea>
				              ...
				              <ul class="pagination">
			              		...
			              		<div class="form-group" style="text-align: left; padding-top: 10px;padding-bottom: 10px">
			                	<a href="#" class="btn btn-success" role="button" id="btntao" > Hoàn Tất  </a>
			                	
			                	<a href="QTNDThongBao.jsp" class="btn btn-danger" role="button"  > Hủy bỏ   </a>
			              	</div>         
       				 </div>
